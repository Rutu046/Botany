...
<div class="citation-container">
    ...
    <div class="policy1">
      <div class="policy-content animated-content">
        <h4 class="table1">●	Figures, schemes and illustrations</h4>
    ...
    <div class="policy1">
      <div class="policy-content animated-content">
        <h4 class="table1">●	Reprints</h4>
        <p class="abc">Authors will receive a PDF file of their paper.</p>
      </div>
